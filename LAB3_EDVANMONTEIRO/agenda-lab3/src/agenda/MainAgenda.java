...
public class MainAgenda {
	...
	private static void listaContatos(Agenda agenda) {
		...
		for (int i = 0; i < contatos.length; i++) {
			if (contatos[i] != null) {
				System.out.println(contatoFormatado(i, contatos[i]));
			}
		}
	}
	...
	/**
	 * Formata o contato na hora de exibir o mesmo
	 * 
	 * @param posicao A posição do contato (que é exibida)/
	 * @param contato O contato a ser impresso.
	 * @return A String formatada.
	 */
	private static String contatoFormatado(int posicao, Contato contato) {
	 ...
	 * 
	 * @param agenda  chama as funçoes da agenda
	 * @param scanner lê o dado a ser processado
	 */
